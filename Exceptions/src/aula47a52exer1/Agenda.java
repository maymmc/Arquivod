...
public class Agenda {
	...
	public void adicionarContato(Contato c) throws AgendaCheiaExeption {
		...
		if (cheia) {
			// lançar uumma exception aqui - pra por uma exceçao precisa criar uma classe da exceçao
			//e addna assinatura do metodo
	...
	public int consultaContatoPorNome(String nome) throws ContatoNaoExisteException {
		...
		//lançar exception contato n existe - criar classe
